...
namespace WindowsFormsApp2
{
    ...
    public partial class SSC_Verification_2022Entities : DbContext
    {
        public SSC_Verification_2022Entities()
            : base("name=SSC_Verification_2022Entities")
        {
        }
        ...
        public virtual DbSet<SSCDATA> SSCDATAs { get; set; }
        public virtual DbSet<SSCDATA_1> SSCDATA_1 { get; set; }
        ...
        public virtual int Sp_Payment_Entry(string clientTxnId, string firstName, string email, string spRespStatus, string udf17, string udf18, string udf20)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_Payment_Entry", clientTxnIdParameter, firstNameParameter, emailParameter, spRespStatusParameter, udf17Parameter, udf18Parameter, udf20Parameter);
        }
    }
}
